...
public class PenClientCtrl implements IPenMsgListener
{
	...
	public static int USING_NOTE_ID = 604; //add by lanlan 2017.3.23 my_note_id
...
//				iPenCtrl.reqAddUsingNoteAll();
				...
				iPenCtrl.reqOfflineData( USING_SECTION_ID, USING_OWNER_ID, USING_NOTE_ID ); //301:demo中的note_id
