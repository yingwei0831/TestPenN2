...
public class SampleViewBack extends SurfaceView implements SurfaceHolder.Callback, DotObserverBack {
...
//    private boolean isSurfaceViewCreated;
     ...
     * 蓝牙笔测试，换做网络通信则需要注释掉
     */
    public SampleViewBack(Context context) {
        super(context);
     ...
     * 蓝牙笔测试，换做网络通信则需要注释掉
     */
    public SampleViewBack(Context context, AttributeSet attrs) {
        super(context, attrs);
        getHolder().addCallback(this);
        mSampleThread = new SampleThread(this.getHolder(), this);
    }
...
//        transactionManager.registerTransactionObserver(this);
    ...
    public SampleViewBack(Context context, String sessionId, String toAccount) {
        super(context);
...
//        isSurfaceViewCreated = false;
    ...
    public class SampleThread extends Thread {
        ...
        private SampleViewBack mSampleiView;
        private boolean running = false;

        public SampleThread(SurfaceHolder surfaceholder, SampleViewBack mView) {
    ...
    @Override
    public void onTransaction(String account, final List<DotBack> transactions) {
        for (DotBack dot : transactions) {
